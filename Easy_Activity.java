...
public class Easy_Activity extends AppCompatActivity {
    ...
    private QuestionModel_Easy currentQuestion;
    private List<QuestionModel_Easy> questionsList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionsList = new ArrayList<QuestionModel_Easy>();
            ...
            public void onClick(View v) {
                if(answered == false) {
                    if(rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()){
                        ...
                        Toast.makeText(Easy_Activity.this, "Please Select an option", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    showNextQuestion();
                }
    ...
    private void addQuestions() {
        questionsList.add(new QuestionModel_Easy("Question is here",
